...
if __name__ == '__main__':
    ...
    checkpoint_dir = '/n/netscratch/nali_lab_seas/Everyone/mingze/datasets/lora_training_w4a8/checkpoints'
    sample_dir = '/n/netscratch/nali_lab_seas/Everyone/mingze/datasets/lora_training_w4a8/samples'
    os.makedirs(sample_dir, exist_ok=True)
    os.makedirs(checkpoint_dir, exist_ok=True)
    # Load model:
    latent_size = int(image_size) // 8
    selected_class_ids = [234, 346, 938, 345]
    ...
    full_dataset = ImageFolder(
        "/n/home11/mingzeyuan/.cache/kagglehub/datasets/ifigotin/imagenetmini-1000/versions/1/imagenet-mini/train",
        transform=transform)
    ...
    model = quantize_dit(model, mode='W4A8')
    ...
    for epoch in tqdm(range(epochs)):
        ...
        for x, y in tqdm(dataloader):
            ...
            t = torch.randint(0,
                              diffusion.num_timesteps, (x.shape[0], ),
                              device=device)
            model_kwargs = {"y": y}
        ...
        # Sample images:
        samples = diffusion.p_sample_loop(model.forward_with_cfg,
                                          z.shape,
                                          z,
                                          clip_denoised=False,
        ...
        save_image(samples,
                   os.path.join(sample_dir, f'sample_{epoch:03d}.png'),
